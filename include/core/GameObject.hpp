...
// static level geometry (Chunk) and dynamic actors (Entity).
class GameObject {
public:
    explicit GameObject(Vector3 position = {0.0f, 0.0f, 0.0f}) : position(position) {}
    ...
    virtual void update(float, const World*) {}
